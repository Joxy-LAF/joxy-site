	...
	<div class="row">
		<div class="span12">
			...
			<p>You will have to find out where your JRE is installed. <span class="distro debian">On Debian and Ubuntu, if you installed Java using <code>apt-get</code>, the JRE will be installed in something like (depending on your Java version) <code>/usr/lib/jvm/java-7-openjdk-i386/jre/</code>.</span> <span class="distro arch"><b>To do: specific information for Arch on how to do this. Do you have that information? Please <a href="http://sourceforge.net/p/joxy/discussion/general/thread/158b3905/">contribute</a>!</b></span> <span class="distro chakra"><b>To do: specific information for Chakra.</b></span> <span class="distro windows">For Windows, depending on your installation, the JRE will be in something like <code>C:\Program Files\Java\jre1.6.0_22</code>.</span></p>
			...
			<span class="distro linux debian arch chakra">
				<p>Now we have the Java code placed in the right directory, we still need to install the shared library containing the native code (the .so file). (This is not obligatory; the shared library only takes care of the native text rendering, and if it cannot be found, Joxy will fallback on default Java text rendering.) You will need to put the .so file in a folder on the Java library path. <span class="distro debian">For Debian/Ubuntu, a safe choice is usually <code>/usr/lib/jni</code>.</span> <span class="distro arch"><b>To do: specific information for Arch on how to do this. Do you have that information? Please <a href="http://sourceforge.net/p/joxy/discussion/general/thread/158b3905/">contribute</a>!</b></span> <span class="distro chakra"><b>To do: specific information for Chakra.</b></span> Tip: if you compiled the library yourself, the <code>compile.sh</code> script gave you a list of directories you can use.</p>
			</span>
